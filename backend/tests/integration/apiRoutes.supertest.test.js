...
vi.mock('../../src/services/ticketService.js', () => ({ ticketService: ticketServiceMock }));
vi.mock('../../src/services/artistService.js', () => ({ artistService: artistServiceMock }));
vi.mock('../../src/services/contactService.js', () => ({ contactService: contactServiceMock }));
