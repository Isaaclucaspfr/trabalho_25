...
import { AppError } from '../../src/utils/erro-aplicacao.js';
...
vi.mock('../../src/services/servico-gateway-pagamento.js', () => ({ paymentGatewayService: gatewayMock }));

const { paymentService } = await import('../../src/services/servico-pagamento.js');
